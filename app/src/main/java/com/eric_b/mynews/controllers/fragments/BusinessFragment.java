...
import com.eric_b.mynews.views.BusinessAdapter;
...
public class BusinessFragment extends BaseFragment implements BusinessAdapter.Listeners {
...
// --------------
    ...
    private void configureRecyclerView(){
        this.mAdapter = new BusinessAdapter( new ArrayList<TopStorieResult>(0), Glide.with(this), new BusinessAdapter.PostItemListener() {
    ...
    private void loadAnswers() {
        this.disposable = TimesStream.streamFetchTopStorieNews("business").subscribeWith(new DisposableObserver <TopStoriePojo>() {
